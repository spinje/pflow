    ...
    def __init_subclass__(cls, **kwargs):
        ...
        def wrapped_init(self, *args, **kwargs):
            ...
            self._config = {
                ...
                if name != "self" and sig.parameters[name].kind not in (inspect.Parameter.VAR_POSITIONAL, inspect.Parameter.VAR_KEYWORD)
            }
            ...
            methods.append(
                {
                    ...
                    "description": (method.__doc__.strip() if method.__doc__ is not None else None),
...
class _BaseResponse:
    ...
    def log_to_db(self, db):
        ...
        response = {
            ...
            "token_details": (json.dumps(self.token_details) if self.token_details else None),
            "schema_id": schema_id,
