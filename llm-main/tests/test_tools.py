...
def test_tool_use_async_tool_function():
    ...
    assert objects == [
        {"prompt": "", "system": "", "attachments": [], "stream": True, "previous": []},
        {
            ...
            "tool_results": [{"name": "hello", "output": "world", "tool_call_id": None}],
        },
    ]
...
async def test_async_tools_run_tools_in_parallel():
    ...
    assert objects == [
        {"prompt": "", "system": "", "attachments": [], "stream": True, "previous": []},
        {
            ...
            "attachments": [],
            "stream": True,
            "previous": [{"prompt": '{"tool_calls": [{"name": "hello"}, {"name": "hello2"}]}'}],
            "tool_results": [
    ...
    result = runner.invoke(
        ...
        (
            [
                ...
                "--functions",
                ERROR_FUNCTION,
                json.dumps({"tool_calls": [{"name": "trigger_error", "arguments": {"msg": "Error!"}}]}),
            ]
