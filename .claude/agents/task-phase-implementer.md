...
- **When the orchestrator hands you the completion gate** (you built the phases and your window
  ...
  its pflow fan-out as a FOREGROUND Bash call (never `run_in_background`; wait for the merged
  report), verify Critical findings against code, apply the correct fixes, and log EVERY finding
