...
Use these terms exactly in every suggestion — don't drift into "component," "service," "API," or "boundary." See [LANGUAGE.md](LANGUAGE.md) for full definitions, principles, and rejected framings.
...
**Use `context/CONTEXT.md` vocabulary for the domain, and [LANGUAGE.md](LANGUAGE.md) vocabulary for the architecture.** If `context/CONTEXT.md` defines "Order," talk about "the Order intake module" — not "the FooBarHandler," and not "the Order service."
