...
# PocketFlow Cookbook Examples Analysis (Part 2)
...
## Advanced Full-Repository Examples (35-41)

These are complete, production-ready applications that demonstrate sophisticated PocketFlow patterns. These examples are more advanced than the basic cookbook examples and represent full repositories with comprehensive implementations.

### 35. PocketFlow-Tutorial-Website-Chatbot
**Path**: `pocketflow/cookbook/PocketFlow-Tutorial-Website-Chatbot/`
**Pattern**: "Set & Forget" AI chatbot with Agent + RAG + Map-Reduce + Workflow
**Purpose**: Build a website chatbot that learns directly from live web content, crawling and understanding your website to answer customer questions
**When to examine**:
- Building autonomous customer support systems
- Implementing intelligent web crawlers
- Creating chatbots that learn from live content
- Combining multiple advanced patterns in one system
**Key features**:
- Agent-based exploration with decision making (explore vs answer)
- Domain-restricted web crawling for safety
- BatchNode for parallel URL processing (5x speedup)
- RAG pattern for webpage content retrieval
- Conditional flow based on agent decisions
- Handles follow-up questions using cached data
- Can refuse irrelevant questions
- **Design Doc**: `docs/design.md`
- **Flow Code**: `flow.py`

### 36. PocketFlow-Tutorial-Danganronpa-Simulator
**Path**: `pocketflow/cookbook/PocketFlow-Tutorial-Danganronpa-Simulator/`
**Pattern**: Multi-agent social deduction game with Async + Agent + State Machine
**Purpose**: Social deduction game (like Mafia/Among Us) where 12 AI agents play against each other with complex game mechanics
**When to examine**:
- Building multi-agent simulations
- Implementing complex game mechanics with AI
- Managing complex state machines
- Creating async agent coordination systems
**Key features**:
- AsyncParallelBatchFlow for concurrent AI decisions
- Complex state machine for game phases (night/day cycles)
- In-memory SQLite for game state and action logging
- Multiple game modes (Player Mode, AI Plays)
- Decision masking based on player perspective
- YAML-based structured LLM responses
- Streamlit web interface
- **Design Doc**: `docs/design.md`
- **Flow Code**: `flow.py`

### 37. Tutorial-Codebase-Knowledge
**Path**: `pocketflow/cookbook/Tutorial-Codebase-Knowledge/`
**Pattern**: Documentation generator with Workflow + BatchNode + Map-Reduce
**Purpose**: Analyzes GitHub repositories and creates beginner-friendly tutorials by understanding code structure and relationships
**When to examine**:
- Building documentation generation tools
- Analyzing codebases programmatically
- Creating educational content from code
- Multi-stage content generation pipelines
**Key features**:
- GitHub repository crawling with smart file filtering
- Identifies core abstractions and dependencies
- Mermaid diagram generation for visualization
- Multi-language tutorial support
- Index-based referencing for efficiency
- Sequential workflow (fetch → identify → analyze → order → write)
- BatchNode for parallel chapter processing
- **Design Doc**: `docs/design.md`
- **Flow Code**: `flow.py`

### 38. Tutorial-Cursor
**Path**: `pocketflow/cookbook/Tutorial-Cursor/`
**Pattern**: AI coding agent with Agent + Nested Flows + Tool Integration
**Purpose**: Mimics Cursor's functionality as an AI coding assistant that can read, edit, and search files based on natural language instructions
**When to examine**:
- Building code editing AI assistants
- Implementing tool-using agents
- Creating nested flow architectures
- File manipulation workflows
**Key features**:
- File operations (read, edit, delete)
- Code search with grep functionality
- Directory tree visualization
- Smart file editing with context understanding
- YAML-based tool selection and parameters
- Edit agent as a sub-flow within main flow
- Handles complex multi-step edits
- **Design Doc**: `docs/design.md`
- **Flow Code**: `flow.py`

### 39. Tutorial-AI-Paul-Graham
**Path**: `pocketflow/cookbook/Tutorial-AI-Paul-Graham/`
**Pattern**: Personality-based RAG with RAG + Map-Reduce + TTS
**Purpose**: RAG system that answers startup/entrepreneurship questions in Paul Graham's style using his essays
**When to examine**:
- Building domain-specific Q&A systems
- Implementing personality mimicry in AI
- Creating voice-enabled applications
- Advanced RAG implementations
**Key features**:
- Two-phase architecture (offline indexing + online querying)
- Text chunking with overlap for better context
- FAISS vector indexing for similarity search
- Topic validation (startup/entrepreneurship only)
- Chunk relevance evaluation before synthesis
- Text-to-speech conversion with caching
- Personality-consistent response generation
- **Design Doc**: `docs/design.md`
- **Flow Code**: `flow.py`

### 40. Tutorial-Youtube-Made-Simple
**Path**: `pocketflow/cookbook/Tutorial-Youtube-Made-Simple/`
**Pattern**: Content summarization with Map-Reduce + Batch Processing
**Purpose**: Summarizes long YouTube videos into ELI5 (Explain Like I'm 5) format with topic extraction
**When to examine**:
...
- Single-prompt topic and question extraction
- BatchNode for parallel topic processing
- HTML output generation with styling
- ELI5 answer formatting
- Efficient content batching
- **Design Doc**: `docs/design.md`
- **Flow Code**: `flow.py`

### 41. Tutorial-Cold-Email-Personalization
**Path**: `pocketflow/cookbook/Tutorial-Cold-Email-Personalization/`
**Pattern**: Web research automation with Map-Reduce + Web Search + Batch Processing
**Purpose**: Generates personalized cold email openers based on automated web research about prospects
**When to examine**:
- Building web research automation
- Creating personalization engines
- Implementing robust batch processing
- Handling failures gracefully
**Key features**:
- Web search integration for prospect research
- Parallel webpage content retrieval
- Factor-based personalization analysis
- CSV batch processing support
- YAML-structured LLM responses
