...
pflow analyze-cache <WORKFLOW> --list-traces
```
...
# List matching traces and the trace that auto-load would pick
pflow analyze-cache ./song-creator.pflow.md --list-traces
