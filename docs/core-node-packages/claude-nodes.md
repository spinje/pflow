...
**Interface**:
- Reads: `shared["prompt"]`: str  # Comprehensive development instructions (generated by planner)
- Writes: `shared["code_report"]`: str  # Complete development output with analysis, implementation, etc.
- Params: `model`: str  # Claude model to use
- Params: `temperature`: float  # Sampling temperature
- Params: `max_tokens`: int  # Maximum response tokens
