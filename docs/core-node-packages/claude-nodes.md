...
The `claude-code` super node receives comprehensive instructions generated by the planner that combine multiple development tasks into a single, cohesive prompt. This approach provides several advantages:
...
The super node writes to comprehensive shared store keys:
