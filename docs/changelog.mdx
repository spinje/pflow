...
<Update label="July 2026" description="v0.14.0" tags={["New releases", "Improvements", "Breaking changes"]}>
  ...
  **Highlights**
  ...
  - Added agent-raised escalation gates, allowing `claude-code` or `code` steps to pause execution using `result.escalation` blocks.
  ...
  **Highlights**
  ...
  - Added self-healing schemas to `claude-code` outputs, enabling scalar type coercion and resume-retries on schema soft-failures.
