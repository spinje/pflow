...
Open one on GitHub and it reads like documentation. Run it with pflow and it executes as a pipeline. Same file, both purposes. No separate documentation to maintain, no opaque config to decipher — the workflow explains itself.
