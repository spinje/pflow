...
class TestPrecedenceOrder:
    ...
    def test_cli_param_overrides_settings_env(self, sample_workflow_ir: dict, settings_with_env: dict) -> None:
        ...
        errors, defaults, _env_param_names = prepare_inputs(sample_workflow_ir, provided_params, settings_with_env)
    ...
    def test_cli_param_overrides_workflow_default(self, sample_workflow_ir: dict) -> None:
        ...
        errors, defaults, _env_param_names = prepare_inputs(sample_workflow_ir, provided_params, {})
...
class TestSettingsEnvPopulation:
    ...
    def test_settings_env_none(self, sample_workflow_ir: dict) -> None:
        ...
        errors, defaults, _env_param_names = prepare_inputs(sample_workflow_ir, provided_params, None)
...
class TestBackwardCompatibility:
    ...
    def test_missing_required_input_still_errors(self, sample_workflow_ir: dict) -> None:
        ...
        errors, _defaults, _env_param_names = prepare_inputs(sample_workflow_ir, provided_params, {})
    ...
    def test_optional_input_default_still_works(self) -> None:
        ...
        errors, defaults, _env_param_names = prepare_inputs(workflow_ir, provided_params, {})
...
class TestEndToEndIntegration:
    ...
    def test_e2e_multiple_workflows_same_settings(self, tmp_path: Path) -> None:
        ...
        # Test workflow 1
        errors1, defaults1, _env_param_names1 = prepare_inputs(workflow1_ir, {"title": "Bug report"}, settings_env)
        assert errors1 == []
        assert defaults1["github_token"] == "ghp_test_token"  # noqa: S105 - Test data comparison

        # Test workflow 2 (reusing same settings)
        errors2, defaults2, _env_param_names2 = prepare_inputs(workflow2_ir, {"branch": "feature-branch"}, settings_env)
        assert errors2 == []
