"""Test parameter value transformation in MetadataGenerationNode."""

from pflow.planning.nodes import MetadataGenerationNode


class TestParameterTransformation:
    """Test the _transform_user_input_with_parameters method."""
    ...
    def test_basic_replacement(self):
        ...
        result = node._transform_user_input_with_parameters(user_input, extracted_params)
