...
"""
    ...
    return [
        ...
        WorkflowTestCase(
            ...
            expected_nodes=["github-get-latest-tag", "git-log", "github-list-issues", "llm", "llm", "write-file", "write-file", "git-commit", "github-create-pr", "github-create-release", "slack-notify"],
            min_nodes=8,
            max_nodes=12,
            ...
            node_output_refs=["get_tag.tag", "get_commits.log", "list_issues.issues", "generate_changelog.response", "generate_notes.response"],
        ...
        WorkflowTestCase(
            ...
            validation_errors=None,
            expected_nodes=["analyze-code", "llm", "llm", "llm", "write-file", "write-file", "write-file", "validate-links", "git-commit", "github-create-pr"],
            min_nodes=8,
            max_nodes=11,
            must_have_inputs=["source_path", "docs_output", "pr_title"],
            must_not_have_inputs=["structure", "functions", "documentation", "examples", "index"],
            node_output_refs=["analyze.structure", "extract.functions", "generate_docs.response", "generate_examples.response", "create_index.response"],
            category="ultra_complex",
        ...
        WorkflowTestCase(
            ...
            validation_errors=None,
            expected_nodes=["github-list-issues", "github-list-prs", "git-log", "llm", "write-file", "write-file", "git-commit", "slack-notify"],
        ...
        WorkflowTestCase(
            ...
            discovered_params={
                "backup_path": "backups/2024-01-15/prod.sql",
        ...
        WorkflowTestCase(
            ...
            discovered_params={
                ...
                "output_file": "blog/testing-guide.md"
            },
            planning_context=base_context,
            browsed_components={
                "llm": {"type": "node"},
        ...
        WorkflowTestCase(
            ...
            node_output_refs=["analyze.structure", "generate_docs.response", "create_index.response", "generate_summary.response"],
            category="complex",
...
def validate_workflow(workflow: dict, test_case: WorkflowTestCase) -> tuple[bool, str]:
    ...
    # Note: We only check for inputs that are actually used in the workflow
    # If the user input has specific values, the LLM might not need all discovered params
    ...
    # Check template variables are used
    ...
    # Check workflow outputs have source field
    ...
    # Check linear workflow (no branching)
    ...
    def test_workflow_generation(self, test_case):
        ...
        if test_case.validation_errors and test_case.browsed_components:
            ...
            planning_context = filter_planning_context_to_browsed(
                test_case.planning_context,
                test_case.browsed_components
            )
