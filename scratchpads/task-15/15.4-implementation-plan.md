...
- [ ] Integration tests cover the full discovery → planning workflow
...
1. Use double quotes only: `shared["key"]` ✅, `shared['key']` ❌
...
- `docs/index.md` - Add entry in reference section
...
1. Create `docs/reference/enhanced-interface-format.md`
...
2. Implement discovery → planning flow tests
