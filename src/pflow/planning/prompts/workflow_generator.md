...
test_runs: [76.9, 76.9, 100.0, 100.0, 100.0]
average_accuracy: 90.8
test_count: 13
previous_version_accuracy: 53.8
last_tested: '2025-08-24'
prompt_hash: a030c66e
last_test_cost: 0.372837
---
...
Use discovered parameters as template variables, but remember:
- These are hints about what the user mentioned
- They should become inputs ONLY if they're starting parameters
- If a value would be generated by a node, don't include it in inputs