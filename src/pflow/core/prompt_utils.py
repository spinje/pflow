"""Simple prompt loading and formatting utilities.

Loads markdown prompt templates, strips YAML frontmatter and H1 headers,
and formats them with strict variable substitution.
"""
...
def load_prompt(prompt_path: Path) -> str:
    ...
    Args:
        prompt_path: Full path to the prompt .md file
