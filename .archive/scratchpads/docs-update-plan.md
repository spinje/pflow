...
This plan must be executed alongside the implementation plans: (you must have misuderstood this, this is not a plan for the implementation, this is a plan for updating the documentation)
