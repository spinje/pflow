...
- Created `architecture/reference/enhanced-interface-format.md`
...
The file `architecture/implementation-details/metadata-extraction.md` is outdated. It describes the old simple format extraction but doesn't cover:
...
- `/architecture/reference/enhanced-interface-format.md` - The specification created
