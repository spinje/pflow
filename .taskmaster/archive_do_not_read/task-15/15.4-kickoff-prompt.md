...
Create `architecture/reference/enhanced-interface-format.md` with:
...
- Tests for discovery → planning workflow
...
- [ ] Integration tests cover discovery → planning workflow
...
5. Focus on the user journey: discovery → selection → planning → workflow generation
