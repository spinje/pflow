...
1. **Primary**: `architecture/features/planner.md` Section 6.1 - Shows how your output will be used
2. **Example**: `architecture/implementation-details/metadata-extraction.md` lines 784-860 - Has PlannerContextBuilder example
